...
#ifndef TEST_IMAP_DISAPPEARINGMAILBOXES
#define TEST_IMAP_DISAPPEARINGMAILBOXES

#include "Utils/LibMailboxSync.h"

class QSignalSpy;

class ImapModelDisappearingMailboxTest : public LibMailboxSync
{
    Q_OBJECT
private slots:

    void testGoingOfflineOnline();
    void helperTestGoingReallyOfflineOnline(bool withUnselect);
