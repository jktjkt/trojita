...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterUncreatableType<Imap::ImapAccess>("trojita.ImapAccess", 0, 1, "ImapAccess",
            QLatin1String("ImapAccess can only be created from the C++ code. Use imapAccess if you need access to an instance."));
