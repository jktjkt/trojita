...
Díky masovému rozšíření chytrých telefonů začal v~posledních letech na významu nabývat mobilní přístup k~elektronické
poště.  Protokol IMAP prošel od svého uvedení na trh mnoha iteracemi, objevila se rozšíření přidávající nové funkce, ale
i optimalizující jeho provoz přes nespolehlivou síť.  Tato práce si klade za cíl provést analýzu stávajících rozšíření
protokolu IMAP v~kontextu jejich použitelnosti a přínosu pro mobilní zařízení.  Obsahuje tři nově vytvořená rozšíření,
ze~kterých každé obohacuje protokol IMAP z~jiného směru.  Součástí práce je též informace o tom, jak byla tato rozšíření
zabudována do programu Trojitá, autorova mobilního e-mailového programu šířeného jako svobodný software.
