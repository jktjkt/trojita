...
Unfortunately, as it happens, such mode of operation comes at a cost.  Support for the required extensions is not
...
approaches.  More information is available in section (\secref{sec:draft-sendmail}) where I present my Internet-Draft
