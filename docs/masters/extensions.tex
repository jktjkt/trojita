...
mailbox in an effort to optimize preloading.

\todo[inline]{VANISHED and how it affects the need to sync uids in the first place -- irony}

\todo[inline]{Propose the ARRIVED due to a race condition}

\todo[inline]{talk about ENABLE and why it's actually necessary (hint: it isn't, really)}
