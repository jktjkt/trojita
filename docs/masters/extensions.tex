...
\todo{Change this section when we support MIME composing with attachments.}
...
Trojitá includes experimental support for the second, submission-over-IMAP variant.  We have proposed an Internet Draft
(\secref{sec:draft-sendmail}) documenting this extension in which the author of this thesis tried to address many
concerns raised during the previous discussion rounds.
...
already mentioned {\tt METADATA} extension.  We have not found a use case for having these optional extensions utilized
