...
\todo[inline]{protocol interaction demo goes here}
...
\todo[inline]{An example of QRESYNC session}
...
\cite{rfc2180} and the generic suggestions to the IMAP implementors (RFC 2683 \cite{rfc2683}) \todo{Add the ``ten
commandments etc}.
