...
untagged {\tt STATUS} command along.  At this time, Trojitá does not support this extension due to technical
reasons.~\footnote{The {\tt LIST} processing is deferred until the client has received all of the untagged responses in
Trojitá; at that time, the {\tt STATUS} responses were already sent.  Changing this code was deemed to be
\todo[inline]{implement me?}}

\todo[inline]{notify \cite{rfc5465}}
