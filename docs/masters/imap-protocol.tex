...
The baseline version of IMAP, as defined in RFC~3501, contains a few features which limits its performance somewhat.
One example of these features are IMAP's {\em synchronizing literals}.
...
% http://mailman2.u.washington.edu/pipermail/imap-protocol/2009-December/001043.html
