...
Thanks to its unique design employing both well-known design patterns as well as
new features offered by the modern Qt toolkit, \trojita certainly has the
potential of becoming {\em the} IMAP client on the open source desktop scene.
