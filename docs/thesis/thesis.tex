...
to read tokens from the byte stream and builds a reply on-the-fly.  Due to the
limitations of polymorphism in C++ and concerns about object lifetime and
ownership, the Parser makes heavy use of the C++ smart pointers, as defined by
the TR1~\cite{std-tr1}.  Error handling is implemented with exceptions.
