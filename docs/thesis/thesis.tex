...
An {\em email message}, or a RFC-822 \footnote{As defined by the RFC822 standard
and subsequently modified by RFC2822\cite{rfc-2822} and others} message,
...
serves as a basis for the {\em envelope} in the IMAP-meaning which are explained
...
Internet host whose purpose is delivery of the RFC2822 mail.  MTAs in the
