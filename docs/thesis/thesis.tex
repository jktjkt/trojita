...
the protocol, as shown by the introduction of non-synchronizing literals.
Support for these extensions is strictly voluntary, and each compliant IMAP
protocol entity has to work even when talking to an implementation supporting
