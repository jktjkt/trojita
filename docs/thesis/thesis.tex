...
e-mail client, \trojita.  Focusing on standard compliance, the client supports
wide range of IMAP features crucial for an efficient implementation such as IDLE
...
memory consumption.  As a results of these optimizations, \trojita operates
...
local process instead of through the TCP socket.  When combined with SSH and the
ssh-agent, it allows for convenient password-less operation without sacrificing
security.
