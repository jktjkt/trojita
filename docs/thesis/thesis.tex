...
message that comes in several different formats, but provide the same
data.  The MUA is expected to pick one of the underlying content types
and display it, perhaps allowing the user to override this selection as a bonus.
