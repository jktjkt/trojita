...
The goal of this thesis was to demonstrate that it is possible to write an IMAP
e-mail client that is usable, yet implements the relevant RFCs properly.  While 
